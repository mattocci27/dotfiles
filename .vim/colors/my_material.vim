...
" |  Color Name  |         RGB        |   Hex   |
" |--------------+--------------------+---------|
" | Black        | rgb(40, 44, 52)    | #263238 |
" |--------------+--------------------+---------|
" | White        | rgb(171, 178, 191) | #AABBC3 |
" |--------------+--------------------+---------|
...
let g:colors_name="my_material"

" Set to "256" for 256-color terminals, or
" set to "16" to use your terminal emulator's native colors
" (a 16-color palette for this color scheme is available; see
" < https://github.com/joshdick/my_material.vim/blob/master/README.md >
" for more information.)
if !exists("g:my_material_termcolors")
  let g:my_material_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:my_material_terminal_italics")
  let g:my_material_terminal_italics = 0
endif
...
function! my_material#set_highlight(group, style)
